...
package uk.gov.hmrc.findmyninoaddtowallet.models

import uk.gov.hmrc.findmyninoaddtowallet.services.ApplePassService.{KEY_NAME, KEY_NINO, KEY_WARNING, LABEL_NAME, LABEL_NINO, TEXT_WARNING}
